...
INSERT INTO `branch_market` VALUES (1,'Nguyễn Kiệm','371 Nguyễn Kiệm, P. 3, Q. Gò Vấp, TP. Hồ Chí Minh'),(2,'Võ Văn Tần','97 Võ Văn Tần P. 6, Q. 3 TP. Hồ Chí Minh'),(3,'Mai Thị Lựu','02 Mai Thị Lựu, P. Đa Kao, Q. 1, TP. Hồ Chí Minh');
...
CREATE TABLE `branch_product` (
  ...
  CONSTRAINT `fk_brpr_product` FOREIGN KEY (`product_id`) REFERENCES `product` (`id`)
...
INSERT INTO `customer` VALUES ('123','Tính','094568465',NULL);
...
INSERT INTO `employee` VALUES ('115dd543-2ef0-417e-941a-177755555f64','Tính nv','tinhculi','123456789','2002-01-01 00:00:00','2023-03-01 00:00:00','0372311672','EMPLOYEE',_binary '',1),('115dd543-2ef0-417e-941a-177756665f64','Huy nhân viên','huyculi','123456789','2002-01-01 00:00:00','2023-03-02 00:00:00','0365507858','EMPLOYEE',_binary '',2),('115dd543-2ef0-417e-941a-17775fde5f64','Tính tester nè','vothanhtinh','123456789','2002-01-01 00:00:00','2023-03-28 00:00:00','0372311677','ADMIN',_binary '',NULL),('115dd543-2ef0-417e-941a-1ec75fde5f64','administrator','admin','admin@123','2002-01-01 00:00:00','2023-03-28 00:00:00','0123456789','ADMIN',_binary '',NULL),('115dd543-77f0-417e-941a-17775fde5f64','Huy test','hangduchuy','123456789','2002-01-01 00:00:00','2023-03-30 00:00:00','0365507859','ADMIN',_binary '',NULL),('8e08cbc8-6699-46f3-92be-45501b6c3a6f','Hùng','hungnewbie','123456789','2002-01-01 00:00:00','2023-04-04 00:00:00','0934831458','ADMIN',_binary '',NULL);
...
INSERT INTO `product` VALUES ('115dd543-06f0-417e-941a-1ec75fde5f77','Bột ngọt hạt lớn Ajinomoto gói 454g','là thương hiệu bột ngọt hạt lớn sản xuất bằng phương pháp lên men tự nhiên từ mật mía đường và tinh bột khoai mì',34400,'BHX',2,3),('115dd543-2ef0-417e-941a-1ec75fde5f64','Kem cầu vòng Iberri hộp 250g','Từ thương hiệu kem iberri quen thuộc, mang đến sự kết hợp giữa nhiều hương vị',59000,'BHX',5,3),('116dd543-06f0-417e-941a-1ec75fde5f64','Bắp cải thảo','là loại rau có bẹ lá to, giòn, ngọt thường được dùng để nấu canh, xào chung với rau củ hoặc để muối kim chi',28000,'BHX',4,1),('609163cb-0f6b-44e1-9ab8-073594a47409','Kẹo the Play More','vị chanh muối chua ngọt và kết hợp cùng bạc hà',15000,'BHX',5,3),('609163cb-0f6b-44e1-9ab8-073594b23409','Coca Cola','Từ thương hiệu nước giải khát hàng đầu thế giới',8000,'BHX',1,2);
...
-- Dump completed on 2023-04-05 22:50:43
